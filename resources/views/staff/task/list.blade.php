                ...
                <table class="table table-bordered">
                    ...
                    @foreach($task as $key=>$task)
                        <tr>
                            ...
                            <td style="text-align: center"><a name="edit-task" href="#" value="{{$task->id}}" data-toggle="modal" data-target="#myModal2"> <span
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" action="{{url("timesheets/$task->timesheet_id/tasks")}}"
                          method="post">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal"  id='form-edit-task' method="post">
                        ...
                        <div class="box-footer">
                            <button type="reset" id="reset-form" class="btn btn-default">Reset</button>
                            <button id="submit-edit-task" type="button" class="btn btn-success pull-right">Submit</button>
                        </div>
                        <!-- /.box-footer -->
                    </form>
                </div>
