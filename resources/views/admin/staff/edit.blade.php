...
@section('content')
    <div class="box box-info">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form class="form-horizontal" action="{{url("admin/staffs/$staff->id")}}" method="post">
            {{ method_field('PUT') }}
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{ $staff->username }}" name="username" class="form-control" id="inputEmail3" placeholder="Username">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="email" value="{{ $staff->email }}" name="email" class="form-control" id="inputEmail3" placeholder="Email" >
                    </div>
                </div>
                <div class="form-group">
